...
<ul class="treeview-menu">
    <li><a href="<?php echo base_url()?>admin/kampus">
        <i class="fa fa-circle-o"></i> Data Kampus</a></li>             
    <li><a href="<?php echo base_url()?>admin/lokasi">
        <i class="fa fa-circle-o"></i> Data Lokasi</a></li>             
    <li><a href="<?php echo base_url()?>admin/jenisbarang">
        <i class="fa fa-circle-o"></i> Data Jenis Barang</a></li>           
    <li><a href="<?php echo base_url()?>admin/kategori">
        <i class="fa fa-circle-o"></i> Data Kategori Barang</a></li>             
    <li><a href="<?php echo base_url()?>admin/merek">
        <i class="fa fa-circle-o"></i> Data Merek</a></li>           \
    <li><a href="<?php echo base_url()?>admin/sumber">
        <i class="fa fa-circle-o"></i> Data Sumber Barang</a></li>
</ul>         
</li>                 
    <li class="treeview">           
        <a href="admin">             

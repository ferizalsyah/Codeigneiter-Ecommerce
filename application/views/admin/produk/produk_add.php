  ...
  <div class="box-header">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url();?>/admin/produk/produk/simpan" enctype='multipart/form-data'>
          ...
          <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="kategori" class="form-control">
                  ...
                  <?php foreach($kt as $item) { ?>
                    <option value="<?php echo $item->id_nomor ?>"><?php echo $item->kategori; ?></option>
                  <?php } ?>
                </select>
              </div>
          </div>
          ...
          <div class="box-footer">
            <a href="<?php echo base_url();?>admin/produk/produk" class="btn btn-danger btn-sm">Batal</a> &nbsp;&nbsp;

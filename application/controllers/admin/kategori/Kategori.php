...
class Kategori  extends CI_Controller {
	...
	public function tambah()
	{
		...
		$isi['data']		= $this->Model_kategori->get_ktgori('tbl_kategori');
		$this->load->view('admin/index',$isi);
	}
	...
	public function hapus($id_nomor)
	{
		...
		?> <script type="text/javascript">alert("delete data kategori berhasil."); window.location.href="<?php echo base_url();?>/admin/kategori/kategori"</script> 
		<?php

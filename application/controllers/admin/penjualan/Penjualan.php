...
class Penjualan extends CI_Controller {
	...
	{
		$isi['content']		= 'admin/penjualan/penjualan_content';
		$isi['judul']		= 'Manajemen data';
		$isi['sub_judul']	= 'Data Barang';
		$isi['data']		= $this->db->get('tbl_pembelian');
		$this->load->view('admin/index',$isi);
	}

	public function tambah()
	{
		$isi['content']		= 'admin/penjualan/penjualan_add';
		$isi['judul']		= 'Manajemen data';
		$isi['sub_judul']	= 'Tambah data barang';
		$isi['kt']			= $this->Penjualan_model->get_ktgori();
		$isi['data']		= $this->Penjualan_model->get_ktgori1('tbl_pembelian');
		$this->load->view('admin/index',$isi);
	}
